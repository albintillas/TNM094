...
struct RandomSystem {
    ...
    const std::vector<glm::vec2>& getPosition() const { return position; }
    const std::vector<float>& getSize() const { return size; }
    const std::vector<glm::vec4>& getColor() const { return color; }
